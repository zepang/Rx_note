...
(function() {
    ...
    document.write("<link rel='stylesheet' type='text/css' href='" + protocol + "//csdnimg.cn/pubfooter/css/pub_footer_1.0.3.css?v=201809272345'/>");
    ...
    var right_public_footer = '<div class="right_box footer_box csdn-tracking-statistics" data-mod="popu_475" data-dsm="post">\
        ...
        <div class="img-box"><img src="//csdnimg.cn/pubfooter/images/csdn_cs_qr.png" alt="客服"><p class="app-text">扫码联系客服</p>\</div>\
        <div class="img-box fr" ><img style="padding:6px;" src="https://www.csdn.net/app/img/wxfix.png" alt="app"><p class="app-text">扫码下载APP</p>\</div>\
        </div>\
        <div class="bg-gray">\
        ...
        <p><a href="http://www.12377.cn/" target="_blank"><span>中国互联网举报中心</span></a>\
        <em class="width126"><a href="http://www.bjjubao.org/" target="_blank"><span>北京互联网违法和不良信息举报中心</span></a></em></p>\
        </div>\
        <div class="app-box">\
        <div class="img-box"><img style="padding:0;" src="//csdnimg.cn/pubfooter/images/csdn-zx.png" alt="官方公众号"><p class="app-text">官方公众号</p></div>\
        <div class="img-box fr"><img style="padding:0;" src="//csdnimg.cn/pubfooter/images/csdn-qkl.png" alt="区块链大本营"><p class="app-text">区块链大本营</p></div>\
        </div>\
        </div>';
